...
//Function Prototypes
void savings(int[], int[], float[], float[], int, int, float);
void display(int[], int[], float[], float[], int, int, float, float, float, float);
...
void display(int year[], int dYear[], float balance[], float interest[], int nYears, int yrDep, float intRate, float salary, float sav2Rtr, float yrDpPc) {
        //Create the Heading for the Savings Account
...
void savings(int year[], int dYear[], float balance[], float interest[], int nYears, int yrDep, float intRate) {

...
//Function Prototypes
void savings(vector<int>&, vector<int>&, vector<float>&, vector<float>&, int, int, float);
void display(vector<int>&, vector<int>&, vector<float>&, vector<float>&, int, int, float, float, float, float);
...
int main(int argc, char** argv) {
    ...
    vector<float> balance(nYears), interest(nYears);
...
void display(vector<int> &year, vector<int> &dYear, vector<float> &balance, vector<float> &interest, int nYears, int yrDep, float intRate, float salary, float sav2Rtr, float yrDpPc) {
        //Create the Heading for the Savings Account
...
void savings(vector<int> &year, vector<int> &dYear, vector<float> &balance, vector<float> &interest, int nYears, int yrDep, float intRate) {
        // Calculate years
    for(int cnt=1;cnt<=nYears;cnt++){
